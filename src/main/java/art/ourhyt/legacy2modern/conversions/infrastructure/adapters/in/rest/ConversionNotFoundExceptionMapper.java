...
@Provider
public class ConversionNotFoundExceptionMapper implements ExceptionMapper<ConversionNotFoundException> {
    @Override
    public Response toResponse(ConversionNotFoundException exception) {
