...
@Provider
public class ConversionNotReadyExceptionMapper implements ExceptionMapper<ConversionNotReadyException> {
    @Override
    public Response toResponse(ConversionNotReadyException exception) {
